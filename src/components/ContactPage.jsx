...
import contactHeroImg from '../assets/contact-hero-best.webp';
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            hero.style.backgroundImage = `url("${contactHeroImg}")`;
    ...
    <div className="fade-in">
      ...
      >
        ...
        <div className="hero-text">
          <h1 className="hero-title-gradient">Contact <span className="notranslate">{getIsTamil() ? 'தி தெரபி யூனிவர்ஸ்' : 'THE THERAPY UNIVERSE'}</span></h1>
        </div>
      </div>
      <Contact />
    </div>
